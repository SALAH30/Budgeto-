...
<html lang="en">
  ...
  <body class="nav-md">
   <?php include('php/sidebare_col.php'); ?>
...
?>
      ...
      <!-- /page title -->
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <form method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">    
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $option['nomCol']?>" id="nom" name="nom" class="form-control col-md-7 col-xs-12">    
                        </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="Theme" value="<?php echo $option['descCol']?>" name="Theme" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                      ...
                      <div class="form-group">
                        ...
                        <div  class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="input-group" id="date_debut" class="pull-left" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc">
                            ...
                            <input type="date" value="<?php echo $option['dateColDebut']?>" id="date_D" name="date_D" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div  class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="input-group" id="date_debut" class="pull-left" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc">
                            ...
                            <input type="date" value="<?php echo $option['dateColFin']?>" id="date_F" name="date_F" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="lieu" value="<?php echo $option['lieuCol']?>" class="form-control col-md-7 col-xs-12" type="text" name="lieu"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" value="<?php echo $option['nbParticipants']?>" id="nbparticipant" name="nbparticipant" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="droit" value="<?php echo $option['droitCol']?>" class="form-control col-md-7 col-xs-12" type="text" name="droit" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <input type="text" hidden value="<?php echo $option['idCol']?>" id="idCol" name="idCol">
                ...
                <button type="button" onclick="Modifer_colloque();" class="btn btn-success">Modifier</button>
                        </div>
                      </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    ...
    <script type="text/javascript" src="js/ajax/ajax_colloque.js"></script>
        <script type="text/javascript" src="js/ajax/ajax_modif_colloque.js"></script>
