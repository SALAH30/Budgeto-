              ...
              <div class="row">
                  		...
                  		<div class="col-md-2 col-sm-2 box0">
                            <a href="#" data-modal data-toggle="tab" data-target="#menus2">
                  			<div class="box1">
					  			...
					  			<h3>Documents  </br> & </br>Archivage</br> </h3>
                  			</div>
                ...
                <div class="fade modal" id="menus3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        ...
                        ">
                            <select class="cs-select cs-skin-slide">
                                <option value="table" data-link="base%20table.php">Les tables</option>
                ...
                <div class="col-lg-12" style="margin-bottom:-50px;">
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            ...
                            <li class="active"><a href="#profile-pills" data-toggle="tab">Document du Stage</a>
                                </li>
                        <li><a href="#home-pills" data-toggle="tab">Résultat du Stage</a>
                                </li>
                                
                            </ul>
                            <div class="tab-content" style="text-align:left;">
                                <div class="tab-pane" id="home-pills">
                                <p>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="btn-group" data-toggle="buttons">
                                            <label style="margin-left:90px;font-size: 18px;" class="btn btn-primary  active">
                                              <input type="radio" name="Suivi" value="Retour" id="option2" />Retour
                                            </label>
            ...
            <h3>NOTIFICATIONS</h3>
                     ...
                     ?>
                      ...
                      <div class="desc" data-modal data-toggle="modal" data-target="#notification" id=<?php echo $row['Code_Stage'] ?> >
                        ...
                        <div class="details">
                          <p><muted style="font-weight:bold;font-size:14px;" >Stage  </muted><?php
                             echo $row['Nom_Fr']." ".$row['Prénom_Fr'] ." <br/>\n";
                     ?>  <br/> 
                             <a href="#" style="text-decoration:underline;font-weight:bold;">Code de PV:</a> <?php echo $row['Code_PV']; ?> <br/>
                     ...
                     <?php
                           ...
                           if ($oo==0) {?>
                            <div class="desc" data-toggle="modal">
                        <div class="thumb">
                          <span class="badge bg-theme"><i class="fa fa-clock-o"></i></span>
                        </div>
                        <div class="details">
