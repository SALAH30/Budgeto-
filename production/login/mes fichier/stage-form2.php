...
<div class="input-group">
<input class="form-control" value="<?php echo $res['Tél_Manifestation']; ?>" type="text" id="requi5" name="requi5"/>
<span class="input-group-addon">
...
<div class="input-group">
<input type="email" value="<?php echo $res['Email_Manifestation']; ?>" id="email4" name="email4" class="form-control" />
<span class="input-group-addon">
...
<div class="input-group">
<input type="url" value="<?php echo $res['Site_Web_Manifestation']; ?>" id="url" name="url" class="form-control" />
<span class="input-group-addon">
<i class="fa fa-site"></i>
                ...
                <section>
                <div class="form-group">
<label for="stage_code" class="control-label">Code de Stage</label>
<input type="text" value="<?php echo $_GET['stage_code']; ?>" hidden class="form-control validate[required]" title=" " name="stage_code" id="stage_code">
</div>
    ...
    <!--footer start-->
          <footer class="site-footer">
              <div class="text-center">
                  ...
                  <a href="stage-form.html#" class="go-top">
