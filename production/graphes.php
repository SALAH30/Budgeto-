...
<html lang="en">
  ...
  <meta name="theme-color" content="#ffffff">
    <title>Budgito | Statistique </title>
...
?>
        ...
        <div class="animated flipInY col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Répartion du bugdet par ressources <small>prévu/réel</small></h2>
            ...
            <div class="row">
              <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Répartion du budget par ressources <small>Réel</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li><a class="close-link"><i class="fa fa-close"></i></a>
			   ...
			   <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Répartion du budget par ressources <small>prévu</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li><a class="close-link"><i class="fa fa-close"></i></a>
                  ...
                  <div class="x_content">
                    <canvas id="canvasDoughnut_2"></canvas>
                  </div>
                </div>
              </div>
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>l'ensemble des participants <small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li><a class="close-link"><i class="fa fa-close"></i></a>
                  ...
                  <div class="x_content">
                    <canvas id="canvasDoughnut_3"></canvas>
                  </div>
                </div>
              </div>
            </div>
    ...
    <script>
      ...
      var mybarChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ["Salles", "Equipements", "Intervenants", "Goodies", "Réstauration" , "Personnel" , "Publicité" , "Ressources" ],
          datasets: [{
            label: '# Réel',
            backgroundColor: "#26B99A",
            data: [<?php echo $coutsalle; ?>, <?php echo $coutequiper; ?>, <?php echo $ren_intervenant+$couttrens+$coutheb; ?>, <?php echo $coutGoo; ?>, <?php echo $coutrepas; ?>,<?php echo $ren_personnel; ?>,<?php echo $cout_pub; ?>,<?php echo $coutR; ?>]
          }, {
            label: '# Estimé',
            backgroundColor: "#03586A",
            data: [<?php echo $coutsalle_estime; ?>, <?php echo $coutequiper_estime; ?>, <?php echo $ren_intervenant_estime+$couttrens_estime+$coutheb_estime; ?>, <?php echo $coutGoo_estime; ?>, <?php echo $coutrepas_estime; ?>,<?php echo $ren_personnel_estime; ?>,<?php echo $cout_pub_estime; ?>,<?php echo $coutR_estime; ?> ]
          }]
        },
	  ...
	  // Doughnut chart
      var ctx = document.getElementById("canvasDoughnut_2");
      var data = {
        labels: ["Salles", "Equipements", "Intervenants", "Goodies", "Réstauration" , "Personnel" , "Publicité" , "Ressources" ],
        datasets: [{
          data: [<?php echo $coutsalle_estime; ?>, <?php echo $coutequiper_estime; ?>, <?php echo $ren_intervenant_estime+$couttrens_estime+$coutheb_estime; ?>, <?php echo $coutGoo_estime; ?>, <?php echo $coutrepas_estime; ?>,<?php echo $ren_personnel_estime; ?>,<?php echo $cout_pub_estime; ?>,<?php echo $coutR_estime; ?> ],
      ...
      var canvasDoughnut = new Chart(ctx, {
        ...
        // Doughnut chart 
        var ctx = document.getElementById("canvasDoughnut_3");
      var data = {
        labels: [
         "Nombre Intervenants","Nombre Personnel", "Nombre Participant"
        ],
        datasets: [{
          data: [<?php echo $nbInt ?>,<?php echo $nbpar ?>,<?php echo $nbParticipants ?>],
          backgroundColor: [
            "#455C73",
            "#9B59B6",
            "#BDC3C7",
