...
<html lang="en">
  ...
  <meta name="theme-color" content="#ffffff">
    <title>Budgito | Gestion des colloques </title>
    ...
    <div class="col-xs-12 col-md-offset-0">
      ...
      <!-- /page title -->
          ...
          <?php
            ...
            $statement = $db->prepare('SELECT * FROM Colloque where idUser='.$_SESSION['iduser']);
            $statement->execute();
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bank"></i><?php echo '   '.$option['nomCol']."  <small>";?> <?php echo 'id :'.$option['idCol'];?></small></h2>
          ...
          <!-- Contenu Colloque -->
                  <div class="x_content">
                    ...
                    <ul class="quick-list">
					  <li><i class="fa fa-flag-o"></i><a>theme: <?php echo $option['descCol'];?> </a>
                      </li>
                      <li><i class="fa fa-calendar-o"></i><a>Date: <?php echo $option['dateColDebut']." jusqu'à ".$option['dateColFin']; ?> </a>
                      </li>
                      <li><i class="fa fa-map-marker"></i><a>Lieu: <?php echo $option['lieuCol'];?></a>
                      </li>
                      <li><i class="fa fa-users"></i><a>Participants: <?php echo $option['nbParticipants'];?></a>
                      </li>
                      <li><i class="fa fa-dollar"></i><a>droit d'inscription : <?php echo number_format($option['droitCol'], 2, ',', '.').' DA';?></a> </li>
          ...
          <!-- /Contenu Colloque -->
                        ...
                        <button type="button" class="btn btn-default btn-block " ><a href="<?php echo "index_col.php?id=".$option['idCol']; ?>">Modifier </a></button>
     ...
     <!-- /colloque1 --> 
        ...
        <!--  AJOUTER AUTRE COLLOQUES-->
              <div class="clearfix"></div>
        
        <!--  CREER AUTRE COLLOQUES-->
      <!-- page title -->
       <div class="page-title">
          <div class="title_left">
          <h3>Ajouter des colloques </h3>
          </div>
        </div>
      <div class="clearfix"></div>
      <!-- /page title -->
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="Theme" name="Theme" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                      ...
                      <div class="form-group">
                        ...
                        <div  class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="input-group" id="date_debut" class="pull-left" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc">
                            ...
                            <input type="date" id="date_D" name="date_D" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div  class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="input-group" id="date_debut" class="pull-left" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc">
                            ...
                            <input type="date" id="date_F" name="date_F" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        <label for="lieu" class="control-label col-md-3 col-sm-3 col-xs-12">Lieu <span class="required">*</span>
            </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="lieu" class="form-control col-md-7 col-xs-12" type="text" name="lieu"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Nombre Participants <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="nbparticipant" name="nbparticipant" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Droit d'inscription <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="droit" class="form-control col-md-7 col-xs-12" type="text" name="droit" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <div id="resultat_col" class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="button" onclick="ajouter_colloque();" class="btn btn-success">Ajouter</button>
                        </div>
                      </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    ...
    <script type="text/javascript" src="js/ajax/ajax_colloque.js"></script>
