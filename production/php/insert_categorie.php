  ...
  function data_base_connect ()
   {
     ...
     return ($dbh);
            ...
            $statement = $db->prepare('INSERT
             INTO CategoriePersonnel ( nomCategorie , prix_estime )
                                          
                       VALUES ( :nomCategorie, :prix_estime )');
                ...
                if(isset($_POST['cout']))
                {
                    ...
                    $statement->bindParam(':prix_estime', $clean['cout']);
                }
                ...
                if(isset($_POST['categor_personnel']))
                {
                     try{
                               $statement->execute();
echo "Catégorie personnel : ".$_POST['categor_personnel']." inséré avec succés";
                    }catch (Exception $e) {
                            exit($e ->getMessage());
                       }
                }
