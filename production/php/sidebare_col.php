            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="index_Col.php"><i class="fa fa-edit"></i> Colloque</a>
                 
                  </li>
                  <li><a href="index_colloque_modif.php"><i class="fa fa-edit"></i> Modifier Colloque</a>
                 
                  </li>
                  <li><a href="calandar.php"><i class="fa fa-calendar"></i> Planning  d\'utilisation des Ressources</a>
                 
                  </li>
                  <li><a href="graphes.php"><i class="fa fa-bar-chart"></i> Graphes </a>
                 
                  </li>

                  <li><a href ="tables.php"><i class="fa fa-table"></i> Tables des Ressources</a>
